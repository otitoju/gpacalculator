...
<div className="card mt-5" id="signup">
    <div className="card-body">
        ...
        <div className="md-form mt-4">
            ...
            <input type="text" id="form3" required="required" className="form-control" value={this.state.fname} onChange={this.handleFname}/>
            <label for="form3">
            <span className="fa fa-user"></span> First Name</label>
        </div>
        <div className="md-form mt-4">
            {/* <i className="fa fa-user prefix"></i> */}
            <input type="text" id="form3" required="required" className="form-control" value={this.state.lname} onChange={this.handleLname}/>
            <label for="form3">
            <span className="fa fa-user"></span>Last Name</label>
        </div>
        ...
        <div className="md-form">
            {/* <i className="fa fa-envelope prefix"></i> */}
            <input type="text" id="form2" className="form-control" value={this.state.department} onChange={this.handleDepart} />
            <label for="form2">
            <span className="fa fa-envelope"></span> Department</label>
        </div>


       <div class="md-form">

                    <select  className="form-control" value={this.state.level} onChange={this.handleGender}>
